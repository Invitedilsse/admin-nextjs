...
import AddFileDrawer from './components/ManageCategoryDrawer'
...
const FileHandle = () => {
  ...
  useEffect(() => {
    setRowCountState(prevRowCountState => (cateCount?.count !== undefined ? cateCount?.count : prevRowCountState))
  }, [cateCount?.count, setRowCountState])

  const handleDebouncedSearch = value => {
    setSearchText(value)
    // debounce(getAllCategory(), 2000)
  }
