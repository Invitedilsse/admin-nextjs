...
const CustomMediaFunction = props => {
  // ** Props
  ...
  const { functionId, custumMedia,
    isCustomMediaFetching } = useSelector(state => state.adminMod)
  ...
  const getallCustomMedia = () => {
    const queryParams = `other_id=${functionId}&limit=${20}&offset=${0}&search_string=${""}&sortDir=${'desc'}&sortBy=${'type'}`
...
export default CustomMediaFunction
