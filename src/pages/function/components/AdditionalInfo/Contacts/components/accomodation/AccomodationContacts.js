...
import AddFileDrawer from './ManageAccomodationDrawer'
import { baseURL } from 'src/services/pathConst'
import { getListOfAccomodation, getListOfMappedContacts } from 'src/store/adminMod'
import toast from 'react-hot-toast'
import { MaterialReactTable, useMaterialReactTable } from 'material-react-table'
import SerialNumberGenerator from 'src/pages/function/components/common/SerialNumberGenerator'

const AccomodationContacts = () => {
  ...
  const { allAccomodations, isMappedContactFetching, mappedContact, mappedContactCount, functionId } = useSelector(state => state.adminMod)
  ...
  const getallAccomodations = () => {
    const queryParams = `function_id=${functionId}&limit=${200}&offset=${0}&search_string=&sortDir=desc&sortBy=title`
...
export default AccomodationContacts
