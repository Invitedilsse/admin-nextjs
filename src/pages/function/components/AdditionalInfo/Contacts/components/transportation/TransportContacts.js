...
import AddFileDrawer from './ManageTransportDrawer'
import { baseURL } from 'src/services/pathConst'
import { getListOfMappedContacts, getListOfTransportation } from 'src/store/adminMod'
...
const TransportContacts = () => {
  ...
  const { allTransportation, isMappedContactFetching, mappedContact, mappedContactCount, functionId } = useSelector(state => state.adminMod)
