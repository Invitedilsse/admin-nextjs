...
function CustomPushNotificationMapping({}) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await apiGet(
        `${postCustomMappedUser}/${functionId}?search_string=${searchText}&oid=${selectedFil}&page=${params.page}&limit=${params.size}`
      )
      console.log('Custom Push Notification Mapping:', response.data)
...
export default CustomPushNotificationMapping
