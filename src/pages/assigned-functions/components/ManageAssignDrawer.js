...
const AssignedFunctionDrawer = props => {
  // ** Props
      ...
      <TabContext value={tabValue} variant='scrollable' scrollButtons='auto'>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          ...
          >
            ...
            <Tab label='Assigned contacts' value={1} />
            ...
            <Tab label='Pre Invite' value={5} disabled={!functionId} />
        ...
        <TabPanel value={1}>
          <Fragment>
            <ListContactsCallers getAll={getAll} id={id} RowData={RowData} />
          </Fragment>
        </TabPanel>
        {/* <TabPanel value={3}>
          {' '}
...
export default AssignedFunctionDrawer
