...
import AddOccasionTemplateDrawer from './addOccasionDrawer'



function ListOccasion({ page }) {
  ...
  const handleDeleteData = async id => {
    ...
    try {
      console.log('body')
      await apiDelete( deleteOccasionListUrl + `/${delId}`)
      fetchData()
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setcontactsFunctionCount(response.data.data.total ||0)
